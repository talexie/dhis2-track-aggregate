...
export class OrgUnitService {
  ...
  getOrgUnitGroupSets = function() {
      return this.http.get(this.constant.ROOTURL + "api/organisationUnitGroupSets.json?fields=id,name,organisationUnitGroups[id,name],attributeValues[value,attribute[id,name,code]]&paging=false").map(function(response) {
