...
module.exports = {
  link: [
    ...
    { rel: 'stylesheet', href: '../../../dhis-web-commons/font-awesome/css/font-awesome.min.css'},
    { rel: 'stylesheet', media: 'screen', href: '../../../dhis-web-commons/css/menu.css'},
    { rel: 'stylesheet', href: '../../../dhis-web-commons/css/widgets.css'},
  

    /** <link> tags for a Web App Manifest **/
    /**{ rel: 'manifest', href: '/assets/manifest.json' } **/
    { rel: 'manifest', href: 'manifest.webapp' }
  ],
  meta: [
